...
from .views import BlogCreateView , BlogDetailsView , BlogUpdateView , BlogDeleteView ,TagcreateView , CategorycreateView , SearchView , BlogFilterationView , TagDeleteView , BlogListView
